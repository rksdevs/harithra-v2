  ...
  return (
    <ServiceSection id="services">
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Design"
          title={<h1>We help in designing aesthetically beautiful houses</h1>}
          subText={
            <h5>
              We listen to our clients requirements and help to design beautiful
              houses to meet their ideas
            </h5>
          }
        />
        <OBJ>
        ...
        <SvgBlock svg="designhouse.jpg" />
      </Content>
      <Content ref={addToRefs}>
        <TextBlock
          topic="Construct"
          title={<h1>We construct the houses you design</h1>}
          subText={
            <h5>
        ...
        <SvgBlock svg="construct2.jpg" />
      </Content>
      <Content>
        <TextBlock
          topic="Repairs & Renovation"
          title={<h1>We repair & renovate existing homes or offices </h1>}
          subText={
            <h5>
              From a complete renovation of existing rooms, flats or offices to
              small repairs, we got it all covered.
            </h5>
          }
        />
        <OBJ>
